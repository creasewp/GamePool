...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <h3>
        ...
        <asp:Label runat="server" ID="ZeroErrorMessage" ForeColor="Red" Visible ="False">Unable to save. There is a game with a zero confidence score</asp:Label> 
    </h3>
            ...
            <table width="100%" border="0">
                ...
                <asp:PlaceHolder runat="server" Visible='<%# IsNotLocked(Container.DataItem) %>'>
                    <tr>
                        ...
                        <td rowspan="2" style="text-align: right">
                            <asp:PlaceHolder runat="server" Visible='<%# IsWorksheetMode %>'>
                                <input name='<%# Eval("Id") %>' value='<%# Eval("Confidence") %>' id='<%# Eval("Id") %>' style="width:45px" />                            
                            </asp:PlaceHolder>

                            <asp:PlaceHolder runat="server"  Visible='<%# !IsWorksheetMode %>'>
                                (<asp:Label runat="server" Text='<%# Eval("Confidence") %>'></asp:Label>)
                                <asp:LinkButton runat="server" Text="Edit" CommandName="EditConfidence" Visible='<%# !IsWorksheetMode %>' ></asp:LinkButton>
